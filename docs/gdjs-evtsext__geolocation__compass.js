...
gdjs.evtsExt__GeoLocation__Compass.Compass.prototype.doStepPreEventsContext.userFunc0x6b9018 = function(runtimeScene, eventsFunctionContext) {
"use strict";
...
gdjs.evtsExt__GeoLocation__Compass.Compass.prototype.doStepPreEventsContext.eventsList0x6dc7cc = function(runtimeScene, eventsFunctionContext) {

{


gdjs.evtsExt__GeoLocation__Compass.Compass.prototype.doStepPreEventsContext.userFunc0x6b9018(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);

}


}; //End of gdjs.evtsExt__GeoLocation__Compass.Compass.prototype.doStepPreEventsContext.eventsList0x6dc7cc
...
{ //Subevents
gdjs.evtsExt__GeoLocation__Compass.Compass.prototype.doStepPreEventsContext.eventsList0x6dc7cc(runtimeScene, eventsFunctionContext);} //End of subevents
}
...
gdjs.evtsExt__GeoLocation__Compass.Compass.prototype.onCreatedContext.userFunc0x6dc690 = function(runtimeScene, eventsFunctionContext) {
"use strict";
runtimeScene.setBackgroundColor(220,200,200);

function orientationListener(event) {
if (event.absolute) {
    const obj = eventsFunctionContext.getObjects('Object');
    var localCompass = obj[0].getVariables().get("CompassHeading");
    localCompass.setNumber(700); 
}
...
if (window.DeviceOrientationAbsoluteEvent) {
    ...
    window.addEventListener("DeviceOrientationAbsoluteEvent", orientationListener);
} // If not, check if the device sends any orientation dat
...
gdjs.evtsExt__GeoLocation__Compass.Compass.prototype.onCreatedContext.userFunc0x6dc690(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
